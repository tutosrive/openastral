export default function ThemeChanger() {
    return (
        <div className="dropdown">
            <div tabIndex={0} role="button" className="btn bg-transparent border-0 outline-0 shadow-none m-1">
                Theme
            ...
            <ul tabIndex={-1} className="translate-x-[-30px] dropdown-content bg-base-300 rounded-box z-1 w-30 p-2 shadow-2xl">
                <li>
