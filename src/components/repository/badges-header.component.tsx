    ...
    return (
        <div className="flex flex-wrap w-full gap-1 align-center justify-center">
            <div className="mx-0.5 badge badge-soft bg-neutral rounded-xl w-auto h-10 z-10">
                <a target="_blank" className="text-primary" href={`${repository.url}/forks`}>
            ...
            {/* Stars Count */}
            <div className="mx-0.5 badge badge-soft bg-neutral rounded-xl w-auto h-10 z-10">
                <a target="_blank" className="text-primary" href={Helpers.getUrlStargazerHistoric(repository)}>
                    <i className="fa-solid fa-star"></i>
                    <span className="truncate">{stargazerCount}</span>
                </a>
            </div>
            {/* Owner Link/Image */}
            <a href={repository.owner.url} target="_blank" className="mx-2 aspect-square h-10 z-10">
