...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            db_version: { Row: { id: number; version: string | null }; Insert: { id?: number; version?: string | null }; Update: { id?: number; version?: string | null }; Relationships: [] };
            ht: { Row: { id: number }; Insert: { id?: number }; Update: { id?: number }; Relationships: [] };
        ...
        Functions: {
            ...
            get_repository: { Args: { ownername: string; reponame: string }; Returns: Json };
        };
